  ...
  return (
    ...
    transition={{duration:0.82}}
     className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
      ...
      onSubmit={handleSearch} className='flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full max-w-md md:max-w-4xl bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
