            ...
            className='space-y-6'>
              ...
              <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                {
                  ...
                  whileInView={{opacity:1,y:0}}
                  transition={{duration:0.4}} key={text} className='flex flex-col items-center bg-light p-4 rounded-lg'>
              ...
              <div>
                 ...
                 <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                  {
                   ["360 Camera", "Bluetooth' uetooth", "GPS", "Heated Seats", "Rear View Mirror"].map((item)=>(
...
transition={{duration:0.6,delay:0.5}} onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
